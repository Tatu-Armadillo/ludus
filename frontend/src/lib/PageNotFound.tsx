...
// Criar cliente axios para autenticação (mesmo padrão do AuthContext)
...
const fetchCurrentUser = async () => {
    try {
        ...
        // Se não estiver autenticado ou houver erro, retorna não autenticado
...
export default function PageNotFound({ }) {
    ...
    const { data: authData, isFetched } = useQuery({
        ...
        // Opcional: evitar refetch desnecessário
